...
export class EnhancedContentGenerationService {
  ...
  private static buildOptimizedPrompt(options: ContentGenerationOptions): string {
    return `Tu es un expert en rédaction publicitaire pour Google Ads. 
...
- Titres: 3 titres maximum 30 caractères chacun
- Descriptions: 2 descriptions maximum 90 caractères chacune
